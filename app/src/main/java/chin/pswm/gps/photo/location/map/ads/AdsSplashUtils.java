...
//                                i2 = i4 + 1;
//                            } else {
//                                myEdit.putString("ads_loading_flg", AdsVariable.ads_loading_flg);
//                                myEdit.putString("ads_loading_flg_all", AdsVariable.ads_loading_flg_all);
//                                myEdit.putString("appOpen", AdsVariable.appOpen);
//                                myEdit.putString("appOpen_on_splash", AdsVariable.appOpen_on_splash);
//                                myEdit.putLong("appOpenSplashTime", AdsVariable.appOpenSplashTime);
//                                myEdit.putString("pubId", AdsVariable.pubId);
...
//                                myEdit.putString("native_text_color_app_name", AdsVariable.native_text_color_app_name);
...
//                                myEdit.putString("full_SplashScreen", AdsVariable.full_SplashScreen);
//                                myEdit.putString("full_PreloadScreen", AdsVariable.full_PreloadScreen);
//                                myEdit.putString("full_StartScreen", AdsVariable.full_StartScreen);
//                                myEdit.putString("full_GPSCameraScreen_Save", AdsVariable.full_GPSCameraScreen_Save);
//                                myEdit.putString("full_PhotoGridScreen_Save", AdsVariable.full_PhotoGridScreen_Save);
//                                myEdit.putString("full_GalleryScreen_Save", AdsVariable.full_GalleryScreen_Save);
//                                myEdit.putString("native_LanguageScreen", AdsVariable.native_LanguageScreen);
//                                myEdit.putString("native_StartScreen", AdsVariable.native_StartScreen);
//                                myEdit.putString("native_TemplateScreen", AdsVariable.native_TemplateScreen);
//                                myEdit.putString("banner_GalleryCameraPreview_Screen", AdsVariable.banner_GalleryCameraPreview_Screen);
//                                myEdit.putString("banner_ImagePreview_Screen", AdsVariable.banner_ImagePreview_Screen);
//                                myEdit.putString("banner_PhotoGrid_Screen", AdsVariable.banner_PhotoGrid_Screen);
//                                myEdit.putString("banner_VideoPreview_Screen", AdsVariable.banner_VideoPreview_Screen);
//                                myEdit.commit();
//                                activity.runOnUiThread(new Runnable() {
//
//
...
//                if (secondsRemaining >= j || isNetworkAvailable()) {
//                    if (secondsRemaining < j) {
//                        MyApplication myApplication = (MyApplication) activity.getApplication();
//                        nextactivity();
//                    }
//                    if (secondsRemaining < j) {
//                        MyApplication myApplication3 = (MyApplication) activity.getApplication();
//                        nextactivity();
//                        return;
//                    }
//                    return;
