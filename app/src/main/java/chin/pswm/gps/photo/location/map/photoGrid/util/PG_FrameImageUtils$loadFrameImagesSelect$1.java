...
final class PG_FrameImageUtils$loadFrameImagesSelect$1 extends AppCompatActivity implements Function2<PG_TemplatePGItem, PG_TemplatePGItem, Integer> {
    public static final PG_FrameImageUtils$loadFrameImagesSelect$1 INSTANCE = new PG_FrameImageUtils$loadFrameImagesSelect$1();

    PG_FrameImageUtils$loadFrameImagesSelect$1() {
        super(2);
    }

    public final Integer invoke(PG_TemplatePGItem pG_TemplatePGItem, PG_TemplatePGItem pG_TemplatePGItem2) {
